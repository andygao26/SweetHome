...
namespace FifthGroup_Backstage.Controllers
{
    public class RepairController : Controller
    {
        ...
        public RepairController(IWebHostEnvironment p, IEmailService emailService, DbHouseContext context)
        {
            _context = context;
            _enviro = p;
        ...
        public async Task<IActionResult> Create(CEmails model)
        {
            ...
            if (model.Repair.photo != null)
            {
                ...
                string path = _enviro.WebRootPath + "/assets/img/repair/" + photoName;
